...
#TODO: put all of these into classes
pygame.font.init()
...
player = pygame.Rect(int(screen_width - 20),
                     int(screen_height / 2 - 70),
                     10,
                     140) # set initial position of player1, rhs
player_speed = 0
...
ball = pygame.Rect(int(screen_width / 2 - 15),
